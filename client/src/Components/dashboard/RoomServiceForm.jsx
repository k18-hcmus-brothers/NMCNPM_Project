      ...
      <div className="row mt-4">
        ...
        <div className="row col-12">
          ...
          <input
            ...
            className="col-1"
            name="SoLuong"
            value={processingService.SoLuong}
          ...
          <input
            ...
            className="col-2"
            readOnly
            value={listOfService[currentSelect - 1].GiaDV}
          />
          <input
            type="number"
            className="col-2"
            readOnly
            value={
              listOfService[currentSelect - 1].GiaDV * processingService.SoLuong
            }
          />
          <input
            type="text"
            className="col-3"
            name="GhiChu"
            value={processingService.GhiChu}
            onChange={onInputChange}
          />
          <div className="col-1">
            <button
            ...
            {services.map((service) => {
              return (
                <tr className="d-flex member-tr">
                  ...
                  <td className="col-2">
                    {numeral(service.GiaDV * service.SoLuong).format(0, 0)}
                  </td>
